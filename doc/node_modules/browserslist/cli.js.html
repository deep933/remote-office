...
<span class="hljs-keyword">var</span> updateDb = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./update-db'</span>)
...
<span class="hljs-keyword">var</span> USAGE = <span class="hljs-string">'Usage:\n'</span> +
            <span class="hljs-string">'  npx browserslist\n'</span> +
            <span class="hljs-string">'  npx browserslist "QUERIES"\n'</span> +
            <span class="hljs-string">'  npx browserslist --json "QUERIES"\n'</span> +
            <span class="hljs-string">'  npx browserslist --config="path/to/browserlist/file"\n'</span> +
            <span class="hljs-string">'  npx browserslist --coverage "QUERIES"\n'</span> +
            <span class="hljs-string">'  npx browserslist --coverage=US "QUERIES"\n'</span> +
            <span class="hljs-string">'  npx browserslist --coverage=US,RU,global "QUERIES"\n'</span> +
            <span class="hljs-string">'  npx browserslist --env="environment name defined in config"\n'</span> +
            <span class="hljs-string">'  npx browserslist --stats="path/to/browserlist/stats/file"\n'</span> +
            <span class="hljs-string">'  npx browserslist --mobile-to-desktop\n'</span> +
            <span class="hljs-string">'  npx browserslist --update-db'</span>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">error</span> (<span class="hljs-params">msg</span>) </span>{
  process.stderr.write(<span class="hljs-string">'browserslist: '</span> + msg + <span class="hljs-string">'\n'</span>)
...
<span class="hljs-keyword">if</span> (isArg(<span class="hljs-string">'--help'</span>) || isArg(<span class="hljs-string">'-h'</span>)) {
  ...
  process.stdout.write(<span class="hljs-string">'browserslist '</span> + pkg.version + <span class="hljs-string">'\n'</span>)
} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (isArg(<span class="hljs-string">'--update-db'</span>)) {
  updateDb(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str</span>) </span>{
  ...
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; args.length; i++) {
    ...
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (name === <span class="hljs-string">'--mobile-to-desktop'</span>) {
      opts.mobileToDesktop = <span class="hljs-literal">true</span>
    } <span class="hljs-keyword">else</span> {
